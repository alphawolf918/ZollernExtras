...
public class RenderBabyDragon extends RenderLiving {
	...
	public void renderTutorial(EntityBabyDragon entity, double par2,
	...
	public void doRender(EntityLiving par1EntityLiving, double par2,
			double par4, double par6, float par8, float par9) {
		renderTutorial((EntityBabyDragon) par1EntityLiving, par2, par4, par6,
				par8, par9);
	}
	...
	public void doRender(Entity par1Entity, double par2, double par4,
		...
		renderTutorial((EntityBabyDragon) par1Entity, par2, par4, par6, par8,
				par9);
	}
