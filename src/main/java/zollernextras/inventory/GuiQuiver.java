...
public class GuiQuiver extends GuiContainer {
	...
	public GuiQuiver(ContainerQuiver containerItem)
	...
	
	{
		...
		String s = this.inventory.hasCustomInventoryName() ? this.inventory
				.getInventoryName() : I18n.format(this.inventory
				.getInventoryName());
		
		this.fontRendererObj.drawString(s, this.xSize / 2
				- this.fontRendererObj.getStringWidth(s) / 2, 0, 4210752);
		
		this.fontRendererObj.drawString(I18n.format("container.inventory"), 26,
				this.ySize - 92 + 4, 4210752);
	}
	...
	
	{
		...
		drawPlayerModel(k + 51, l + 65, 30, k + 51 - this.xSize_lo, l + 75 - 50
